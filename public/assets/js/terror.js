...
const url_terror =
  `https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=true&language=${lang}-MX&page=1&sort_by=popularity.desc&with_genres=27`;
const options_terror = {
  method: "GET",
  headers: {
...
fetch(url_terror, options_terror)
  .then((res) => res.json())
  .then((json) => {
    const movieListElement = document.getElementById("movie_terror");
    let htmlContent = "";
